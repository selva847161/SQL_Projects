...
--What percent of the total does the top interchange 
--volume merchant represent?
...
/*
Can we see the current rank, interchange revenue, and percentage of total versus the previous month’s rank, 
interchange revenue, and percentage of total?
*/
WITH MonthlyData AS 
(
    SELECT  
...
/*
Create a derived table of merchants for current and 
previous month ranks by reporting date.
*/
WITH Latest AS (
    SELECT 
